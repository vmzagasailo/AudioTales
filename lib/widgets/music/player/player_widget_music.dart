...
class _MusicPlayerWidgetState extends State<MusicPlayerWidget> {
  ...
  File jsonFile;
  Directory dir;
  String fileName = "favoriteMusic.json";
  ...
  Widget build(BuildContext context) {
    var musicDetailsJSON = widget.musicDetailsJSON;
    ...
    void writeToFile() {
      ...
      if (fileExists && checkFavor == false) {
        favoriteDataMusic.add(musicDetailsJSON);
              ...
              Padding(
                ...
                child: Text(
                  Platform.isAndroid
                      ...
                      : (widget.musicDetailsJSON.duration.length == 5)
                          ? '0:' + widget.musicDetailsJSON.duration
                      ...
                      child: Container(
                        ...
                        child: SizedBox(
                          ...
                          child: Align(
                            alignment: Alignment.center,
                            child: Text(
                              checkFavor == false || favoriteDataMusic == null
                                  ? 'ДОБАВИТЬ В ЛЮБИМОЕ'
                                  : 'УДАЛИТЬ ИЗ ЛЮБИМОГО',
                              maxLines: 2,
                              style: TextStyle(
                      ...
                      onPressed: () => setState(
                        () => {
                          ...
                          if (checkFavor)
                            ...
                            {
                              musicDetailsJSON.favorite = true,
                              writeToFile(),
                              checkFavor = true,
                              Fluttertoast.showToast(
    ...
    _audioPlayer.onDurationChanged.listen((duration) {
      ...
      if (Theme.of(context).platform == TargetPlatform.iOS) {
        ...
        _audioPlayer.setNotification(
            ...
            imageUrl:
                'https://audiotales.exyte.top/imageItems/${widget.musicDetailsJSON.id}.png',
