...
class FilmDetails extends StatefulWidget {
  ...
  FilmDetails({Key key, this.taleInf}) : super(key: key);
...
class _FilmDetailsState extends State<FilmDetails> {
  ...
  Widget build(BuildContext context) {
        ...
        IconButton(
          ...
          onPressed: () {
            var route = MaterialPageRoute(
                ...
                builder: (BuildContext context) => Hints(currId: 5));
    ...
    return Scaffold(
        ...
        appBar: appBar,
        body: Container(
          child: FutureBuilder<List<FilmDetailsJSON>>(
              future: talesData.fetchFilmsDetails(widget.taleInf.id),
                                ...
                                if (Platform.isIOS) {
                                  var route = MaterialPageRoute(
                                    builder: (BuildContext context) => FilmPage(
                                        filmDetailsJSON: snapshot.data[index]),
                                  );
                                  Navigator.of(context).push(route);
